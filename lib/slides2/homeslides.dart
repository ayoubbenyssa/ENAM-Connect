...
import 'package:enamconnect/slides2/page_dragger.dart';
import 'package:enamconnect/slides2/page_reveal.dart';
import 'package:enamconnect/slides2/pager_indicator.dart';
import 'package:enamconnect/slides2/pages.dart' as pa;
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: <Widget>[
            ...
            Text("ENAM Connect",style: TextStyle(
              fontSize: 24,
              color: Colors.black,
