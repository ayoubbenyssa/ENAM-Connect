...
class Fonts {
  ...
  static const Color col_app = const Color(0xff92BA92);
  static const Color col_app_fon = const Color(0xff92BA92);
  ...
  static const Color col_text = const Color(0xff525E75);
