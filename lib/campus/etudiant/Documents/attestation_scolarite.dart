...
class Attestation_scolarite extends StatefulWidget {

  @override
  _Attestation_scolariteState createState() => _Attestation_scolariteState();
}

class _Attestation_scolariteState extends State<Attestation_scolarite> {
