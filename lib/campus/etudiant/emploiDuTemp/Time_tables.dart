...
//http://ifd-erp.tk
 ...
 Widget drop_down1 = new Container(
   ...
   decoration: new BoxDecoration(
     color: Fonts.col_cl,
     border: new Border.all(color: Fonts.col_text, width: 0.5),
   ...
   child: new DropdownButton(
       ...
       isExpanded: true,
       iconSize: 32.0.r,
       icon: Icon(Icons.arrow_drop_down,color: Fonts.col_text,),
       isDense: false,
       hint: new Text(
         periode
         ...
         maxLines: 2,
         softWrap: true,
         style: new TextStyle(color: Fonts.col_text , fontSize: 15.sp ,fontWeight: FontWeight.bold),
       ),
       items: listItem,
     ...
     tab(title){
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Fonts.col_text , width: 0.5.r,style: BorderStyle.solid),
        ),
