                        ...
                        children: <Widget>[
                          Container(
                            child: Text(
                              ...
                              style: TextStyle(fontSize: 12.0.sp,fontWeight: FontWeight.w500,color: Fonts.col_text ),
                            ),
                          ),
                            ...
                            children: [
                              Container(
                                ...
                                Text("${element.subjectWeighting}",
                                  style: TextStyle(fontSize: 15.0.sp,fontWeight: FontWeight.bold,color: Fonts.col_text ),
